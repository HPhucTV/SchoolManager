...
from app.routers import ai, auth, activities, invitations, dashboard, students, statistics, assignments, student_api, classes, quizzes, games, notifications, admin, schedule_api, wellness, ai_tutor, gamification, analytics, parent, quiz_battle
